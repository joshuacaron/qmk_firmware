 ...
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Del    |   Q  |   W  |   E  |   R  |   T  | TGL  |           | TGL  |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------| MEDIA|           | SYMB |------+------+------+------+------+--------|
 * | BkSp   |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2|' / Cmd |
 * |--------+------+------+------+------+------| CTRL+|           | CTRL |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  | Tab  |           | SHF+T|   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   LCTL(KC_TAB),
        ...
        // right hand
             ...
             LCTL(LSFT(KC_T)),KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
